...
budget = (5, 5, 5) # TODO: measure time for whole BO process and increase or decrease budget accordingly, to run within 24hrs
...
def to_grakel_graph_1(t):
    ...
    relabel = {n: "Activation" if ("Sigmoid" in n or "ReLu" in n or "Tanh" in n or "LTE" in n) else "Node"
               for n in G.nodes()}
