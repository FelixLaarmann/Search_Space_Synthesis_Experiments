...
if __name__ == "__main__":
    ...
    plt.savefig(f'{folder}/ktau_k1_robust_{EXPERIMENT_NUMBER}.png')
    plt.savefig(f'{folder}/ktau_k1_robust_{EXPERIMENT_NUMBER}.pdf')
    plt.close()
    ...
    plt.savefig(f'{folder}/pc_k1_robust_{EXPERIMENT_NUMBER}.png')
    plt.savefig(f'{folder}/pc_k1_robust_{EXPERIMENT_NUMBER}.pdf')
    plt.close()
    ...
    plt.savefig(f'{folder}/ktau_k2_robust_{EXPERIMENT_NUMBER}.png')
    plt.savefig(f'{folder}/ktau_k2_robust_{EXPERIMENT_NUMBER}.pdf')
    plt.close()
    ...
    plt.savefig(f'{folder}/pc_k2_robust_{EXPERIMENT_NUMBER}.png')
    plt.savefig(f'{folder}/pc_k2_robust_{EXPERIMENT_NUMBER}.pdf')
    plt.close()
    ...
    plt.savefig(f'{folder}/ktau_k3_robust_{EXPERIMENT_NUMBER}.png')
    plt.savefig(f'{folder}/ktau_k3_robust_{EXPERIMENT_NUMBER}.pdf')
    plt.close()
    ...
    plt.savefig(f'{folder}/pc_k3_robust_{EXPERIMENT_NUMBER}.png')
    plt.savefig(f'{folder}/pc_k3_robust_{EXPERIMENT_NUMBER}.pdf')
    plt.close()
    """
    ...
    plt.savefig(f'{folder}/ktau_k1_variance_{EXPERIMENT_NUMBER}.png')
    plt.savefig(f'{folder}/ktau_k1_variance_{EXPERIMENT_NUMBER}.pdf')
    plt.close()
    ...
    plt.savefig(f'{folder}/pc_k1_variance_{EXPERIMENT_NUMBER}.png')
    plt.savefig(f'{folder}/pc_k1_variance_{EXPERIMENT_NUMBER}.pdf')
    plt.close()
    ...
    plt.savefig(f'{folder}/ktau_k2_variance_{EXPERIMENT_NUMBER}.png')
    plt.savefig(f'{folder}/ktau_k2_variance_{EXPERIMENT_NUMBER}.pdf')
    plt.close()
    ...
    plt.savefig(f'{folder}/pc_k2_variance_{EXPERIMENT_NUMBER}.png')
    plt.savefig(f'{folder}/pc_k2_variance_{EXPERIMENT_NUMBER}.pdf')
    plt.close()
    ...
    plt.savefig(f'{folder}/ktau_k3_variance_{EXPERIMENT_NUMBER}.png')
    plt.savefig(f'{folder}/ktau_k3_variance_{EXPERIMENT_NUMBER}.pdf')
    plt.close()
    ...
    plt.savefig(f'{folder}/pc_k3_variance_{EXPERIMENT_NUMBER}.png')
    plt.savefig(f'{folder}/pc_k3_variance_{EXPERIMENT_NUMBER}.pdf')
    plt.close()
    """
    ...
    plt.savefig(f'{folder}/ktau_k1_redundant_{EXPERIMENT_NUMBER}.png')
    plt.savefig(f'{folder}/ktau_k1_redundant_{EXPERIMENT_NUMBER}.pdf')
    plt.close()
    ...
    plt.savefig(f'{folder}/pc_k1_redundant_{EXPERIMENT_NUMBER}.png')
    plt.savefig(f'{folder}/pc_k1_redundant_{EXPERIMENT_NUMBER}.pdf')
    plt.close()
    ...
    plt.savefig(f'{folder}/ktau_k2_redundant_{EXPERIMENT_NUMBER}.png')
    plt.savefig(f'{folder}/ktau_k2_redundant_{EXPERIMENT_NUMBER}.pdf')
    plt.close()
    ...
    plt.savefig(f'{folder}/pc_k2_redundant_{EXPERIMENT_NUMBER}.png')
    plt.savefig(f'{folder}/pc_k2_redundant_{EXPERIMENT_NUMBER}.pdf')
    plt.close()
    ...
    plt.savefig(f'{folder}/ktau_k3_redundant_{EXPERIMENT_NUMBER}.png')
    plt.savefig(f'{folder}/ktau_k3_redundant_{EXPERIMENT_NUMBER}.pdf')
    plt.close()
    ...
    plt.savefig(f'{folder}/pc_k3_redundant_{EXPERIMENT_NUMBER}.png')
    plt.savefig(f'{folder}/pc_k3_redundant_{EXPERIMENT_NUMBER}.pdf')
    plt.close()
    """
