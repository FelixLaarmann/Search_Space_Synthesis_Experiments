...
class ODE_DAG_Repository:
    ...
    def specification(self):
        ...
        return {
            ...
            .parameter("l", labels, lambda v: list(labels.iter_sharpness_sigmoid()))
            .parameter("i", dimension, lambda v: [1])
            .parameter("o", dimension)
            .parameter("para1", para_labels, lambda v: [(v["l"], v["i"], v["o"])])
            .parameter("para2", para_labels, lambda v: [(v["l"], v["i"], None)])
            ...
            .suffix(Constructor("DAG_component",
                                ...
                                & Constructor("structure", Var("para6"))
                                & Constructor("structure", Var("para7"))
                                #& Constructor("structure", Literal("sharpness_sigmoid"))
                                & Constructor("structure", Literal(None))
                                ) & Constructor("non_ID")
                    ),
            ...
            .suffix(Constructor("DAG_component",
                                ...
                                & Constructor("structure", Var("para6"))
                                & Constructor("structure", Var("para7"))
                                #& Constructor("structure", Literal("lte"))
                                & Constructor("structure", Literal(None))
                                ) & Constructor("non_ID")
                    ),
    ...
    def pretty_term_algebra(self):
        return {
            ...
            "sharpness_sigmoid": (lambda l, i, o, para1, para2, para3, para4, para5, para6, para7: f"({str(l)}, {i}, {o})"),
...
""")
    ...
    def edgelist_algebra(self):
        return {
            ...
            "sharpness_sigmoid": (
                lambda l, i, o, para1, para2, para3, para4, para5, para6, para7: lambda id, inputs: (
                [(x, str((l, i, o)) + str(id)) for x in inputs], [str((l, i, o)) + str(id) for _ in range(0, o)],
                {str((l, i, o)) + str(id): id})),
